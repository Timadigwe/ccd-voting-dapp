...
async fn main() -> Result<(), Error> {
    ...
    let init_method_name: &str = "init_ccd_voting_dapp"; // Example
    ...
    use ccd_voting_dapp::MyInputType; // Example
    ...
    let update_payload = transactions::UpdateContractPayload {
        ...
        receive_name: OwnedReceiveName::new_unchecked("ccd_voting_dapp.receive".to_string()),
